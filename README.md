...
SegFormer-b2 was selected after benchmarking 10 segmentation architectures — SegFormer-b0/b1/b2, and five CNN decoder architectures (U-Net, U-Net++, DeepLabV3+, FPN, MAnet) with ResNet34 encoders, plus MobileNetV2 and EfficientNet-B0 encoder variants on U-Net and DeepLabV3+ respectively — across all three datasets. Full results are in [`evaluation/model_comparison.csv`](evaluation/model_comparison.csv).
